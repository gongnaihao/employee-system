...
public class EmpService {
	...
	@Autowired
	 ...
	 public List<Employee> seachByname(Long did){
		 return empRepository.findBydptname(did);

	 }
	 public List<Employee> seachzaizhi(Long did){
		 return empRepository.findzaizhi(did);
